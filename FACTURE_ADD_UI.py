...
class FACTURE_ADD_UI(QDialog):
    def __init__(self, Dialog):
        ...
        self.DATE_EDIT.setDateTime(QtCore.QDateTime(QtCore.QDate(2020, 5, 23),
                                                   QtCore.QTime(0, 0, 0)))
        ...
        self.DESCRIPTION_ACTIVITE_LABEL.setGeometry(QtCore.QRect(10, 520, 81, 22))
        ...
        self.DESCRIPTION_ACTIVITE_EDIT.setGeometry(QtCore.QRect(10, 540, 451, 22))
        ...
        TSF = QtCore.QDateTime(QtCore.QDate(2020, 5, 23), QtCore.QTime(0, 0, 0))
