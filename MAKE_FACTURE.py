...
class FACTURE_PDF:
    ...
    def __init__(self, ID):
        ...
        #os.system("start {}".format("result.pdf"))
        ...
        if(len(TEST) == 1):
            ...
            print(TEST2)
            if(len(TEST2) == 0):
                os.system("mv FACTURES/FACTURE_{}.pdf FACTURES/ARCHIVES/FACTURE_{}_1.pdf".format(ID, ID))
            else:
                for t in TEST2:
                    TS = int(rsplit("_|[.]", t)[2])
                    os.system("mv FACTURES/ARCHIVES/FACTURE_{}_{}.pdf FACTURES/ARCHIVES/FACTURE_{}_{}.pdf".format(ID, TS, ID, TS+1))
                os.system("mv FACTURES/FACTURE_{}.pdf FACTURES/ARCHIVES/FACTURE_{}_1.pdf".format(ID, ID))
    ...
    def periode(self, F):
        MOIS = ("Jan", u"Fév", u"Mar", u"Avr",
                ...
                "Sep", "Oct" , "Nov" , u"Déc")
        if F.PERIODE_MAX_MS == 0 or F.PERIODE_MAX_MS == None:
