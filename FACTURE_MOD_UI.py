...
from TARIF import TARIF, TARIF_LIST
from FACTURE_ACTIVITE import FACTURE_ACTIVITE, FACTURE_ACTIVITE_LIST
...
class FACTURE_MOD_UI(QDialog):
    def __init__(self, Dialog):
        ...
        self.DESCRIPTION_ACTIVITE_LABEL.setGeometry(QtCore.QRect(10, 550, 81, 22))
        self.DESCRIPTION_ACTIVITE_LABEL.setObjectName("DESCRIPTION_ACTIVITE_LABEL")

        self.DESCRIPTION_ACTIVITE_EDIT = QtWidgets.QLineEdit(self)
        self.DESCRIPTION_ACTIVITE_EDIT.setGeometry(QtCore.QRect(10, 570, 451, 22))
        self.DESCRIPTION_ACTIVITE_EDIT.setObjectName("DESCRIPTION_ACTIVITE_EDIT")
        ...
        self.NB_HEURES_EDIT.setInputMethodHints(QtCore.Qt.ImhFormattedNumbersOnly)
        ...
        self.VOIR_FACTURE_PDF_BUTTON.setGeometry(QtCore.QRect(520, 130, 151, 28))
        ...
        Dialog.setTabOrder(self.RETIRER_PUSH_BUTTON, self.DESCRIPTION_ACTIVITE_EDIT)
        Dialog.setTabOrder(self.DESCRIPTION_ACTIVITE_EDIT, self.DATE_ACTIVITE_EDIT)
        ...
        Dialog.setTabOrder(self.CREER_FACTURE_BUTTON, self.VOIR_FACTURE_PDF_BUTTON)
        ...
        self.DATE_EDIT.setDate(QtCore.QDate.fromString(cFACT.DATE, "yyyy-MM-dd"))
    ...
    def PREPARE_FACTURE(self, ID):
        FP = FACTURE_PDF(self.FL.FL[self.ID].ID)
    ...
    def MOD_FACTURE(self, parent):        
        ...
        parent.FL.update(ID = int(self.ID_PROJET_EDIT.text()),
                         ...
                         ID_CLIENT = self.CL.CL[self.CLIENT_COMBO.currentIndex()].ID,
                         ID_STATUT = self.STATUT_FACTURE_COMBO.currentIndex() + 1,
                         ID_TARIF = self.TL.TL[self.TARIF_COMBO.currentIndex()].ID,
                         FACTURE_PDF = 1)
    ...
    def ADD_ACTIVITE(self):
        ...
        item = QtWidgets.QListWidgetItem("{} [{} hrs] {}".format(self.DATE_ACTIVITE_EDIT.text(),
    ...
    def OPEN_FACTURE(self):
        system("start " + "FACTURES/FACTURE_{}.pdf".format(int(self.ID_PROJET_EDIT.text())))
    ...
    def retranslateUi(self, Dialog):
        ...
        # Label
        self.DESCRIPTION_ACTIVITE_LABEL.setText(_translate("Dialog", "DESCRIPTION"))
        self.DATE_ACTIVITE_LABEL.setText(_translate("Dialog", "DATE DE LA FACTURE"))
        self.ACTIVITE_LABEL.setText(_translate("Dialog", "ACTIVITÉS DE LA FACTURE"))
        self.NB_HEURES_LABEL.setText(_translate("Dialog", "NOMBRE D\'HEURES"))

        # Bouton pour ajouter et retirer des activités de la facture. 
        self.AJOUTER_PUSH_BUTTON.setText(_translate("Dialog", "AJOUTER ACTIVITÉ DE LA FACTURE"))
        self.RETIRER_PUSH_BUTTON.setText(_translate("Dialog", "RETIRER ACTIVITÉ DE LA FACTURE"))

        # Voir/Créer la facture
        self.CREER_FACTURE_BUTTON.setText(_translate("Dialog", "CRÉER LA FACTURE PDF"))
        self.VOIR_FACTURE_PDF_BUTTON.setText(_translate("Dialog", "VOIR LA FACTURE PDF"))                

        # Valeur et label du statut de la facture.
        self.STATUT_FACTURE_LABEL.setText(_translate("Dialog", "STATUT FACTURE"))
        self.STATUT_FACTURE_COMBO.setItemText(0, _translate("Dialog", "EN ATTENTE"))
        self.STATUT_FACTURE_COMBO.setItemText(1, _translate("Dialog", "PAYÉ"))
        self.STATUT_FACTURE_COMBO.setItemText(2, _translate("Dialog", "ANNULÉ"))
