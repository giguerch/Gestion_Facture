...
from ADRESSE import ADRESSE_LIST
from functools import partial


class Ui_ADRESSE(QDialog):
    ''''Interface d'utilisateur des adresses '''
    ...
    def reload(self):
        ...
        for i, j in enumerate(self.AL.CL):
            if self.AL.CLF[i]:
                ...
                QtWidgets.QTreeWidgetItem(item_0)
                QtWidgets.QTreeWidgetItem(item_0)
                top = self.Liste_Adresse.topLevelItem(test)
                top.setText(0, j.NOM)
                top.child(0).setText(0, j.LIEU1)
                top.child(1).setText(0, j.LIEU2)
                top.child(2).setText(0, j.ADRESSE)
                top.child(3).setText(0, j.VILLE)
                top.child(4).setText(0, j.PROVINCE)
                top.child(5).setText(0, j.CP)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.Liste_Adresse.headerItem().setText(0,
                                                _translate("Dialog",
                                                           "Adresse de " +
                                                           "Facturation"))
        ...
        self.Ajouter_Adresse.setText(_translate("Dialog",
                                                "Ajouter à la liste"))
        self.Retirer_Adresse.setText(_translate("Dialog",
                                                "Retirer à la liste"))
